...
class WeldGloveAlgo {
public:
    WeldGloveAlgo(const WeldGloveAlgoConfig &config);
    ~WeldGloveAlgo();
...
private:
    WeldGloveAlgoConfig config_;

    class WeldGloveAlgoPrivate;
    std::unique_ptr<WeldGloveAlgoPrivate> private_;
};
